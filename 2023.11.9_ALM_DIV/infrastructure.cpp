...
void print_B(double ***F, double ***G, double **triangles_uv, int num_modes, int nfp_ft, int num_scalar) {
    ...
    for (int l = 2; l < 3; l++) {
        ...
        for (int i = 0; i < (int) triangles_uv[0][6]; i++) {
            ...
            // printf("%0.9f  %0.9f  %0.9f  %0.9f  %0.9f  %0.9f  %0.9f  %0.9f  %0.9f  %0.9f  %0.9f  %0.9f\n", sqrt(f1[0]*f1[0]+f1[1]*f1[1]+f1[2]*f1[2]), \
            // sqrt(f2[0]*f2[0]+f2[1]*f2[1]+f2[2]*f2[2]), \
            // sqrt(f3[0]*f3[0]+f3[1]*f3[1]+f3[2]*f3[2]), \
            // f1[0], f2[0], f3[0], \
            // f1[1], f2[1], f3[1], \
            // f1[2], f2[2], f3[2]);
        // printf("%0.9f  %0.9f  %0.9f\n", sqrt(f_modes_2d[0][0]*f_modes_2d[0][0]+f_modes_2d[1][0]*f_modes_2d[1][0]+f_modes_2d[2][0]*f_modes_2d[2][0]), \
        // sqrt(f_modes_2d[0][6]*f_modes_2d[0][6]+f_modes_2d[1][6]*f_modes_2d[1][6]+f_modes_2d[2][6]*f_modes_2d[2][6]), \
        // sqrt(f_modes_2d[0][12]*f_modes_2d[0][12]+f_modes_2d[1][12]*f_modes_2d[1][12]+f_modes_2d[2][12]*f_modes_2d[2][12]));
        // printf("%0.9f  %0.9f  %0.9f\n", f_modes_2d[0], f_modes_2d[6], f_modes_2d[12]);
        }
        printf("\n\n\n\n\n");
    }
    fflush(stdout);
...
void print_p(double **F, double ***G, double **triangles_uv, int num_modes, int nfp_ft) {
    ...
    for (int l = 0; l < 3; l++) {
        ...
        for (int i = 0; i < (int) triangles_uv[0][6]; i++) {
            ...
            printf("%0.9f  %0.9f  %0.9f\n", sqrt(f1*f1+f1*f1+f1*f1), \
            sqrt(f2*f2+f2*f2+f2*f2), \
            sqrt(f3*f3+f3*f3+f3*f3));
        }
        printf("\n\n\n\n\n");
    }
    fflush(stdout);
