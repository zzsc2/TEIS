...
double ***solve_magnetic_field_sparse_direct(double ***M_tri_18Nn_18Nn, double **B_tri_18Nn, int **points_sequence, double **boundary_DoFs, int num_modes, int num_triangles_in_plane, int num_scalar, double error, time_t time_s);
double ***solve_magnetic_field_sparse_guess(double ***guess_sca_tri_18N, double ***M_tri_18Nn_18Nn, double **B_tri_18Nn, int **points_sequence, double **boundary_DoFs, int num_modes, int num_triangles_in_plane, int num_scalar, double error, time_t time_s);
double ***solve_magnetic_field_sparse_lagrange_multiplier(double ***M_tri_18Nn_18Nn, double **B_tri_18Nn, int **points_sequence, double **boundary_DoFs, int num_modes, int num_triangles_in_plane, int num_scalar, int flag, double error, time_t time_s);
double ***solve_magnetic_field_sparse_lagrange_multiplier_div(double**** divergence_tri_3_var_modes, double ***M_tri_18Nn_18Nn, double **B_tri_18Nn, int **points_sequence, double **boundary_DoFs, int num_modes, int num_triangles_in_plane, int nfp_ft, int num_scalar, int flag, double error, time_t time_s);
double ***solve_magnetic_field_sparse_ALM_div(double**** divergence_tri_3_var_modes, double ***M_tri_18Nn_18Nn, double **B_tri_18Nn, int **points_sequence, double **boundary_DoFs, double **normal_DoFs, int num_modes, int num_triangles_in_plane, int nfp_ft, int num_scalar, int flag, double error, time_t time_s);
